...
remove(knn.kfoldCV.plot,
       ...
       knn.repeatedCV.plot,
       knn.repeatedCV_mod.plot)
remove(knn.kfoldCV.ROC.plot,
       knn.kfoldCV_mod.ROC.plot,
       knn.holdoutCV.ROC.plot,
       knn.holdoutCV_mod.ROC.plot,
       knn.looCV.ROC.plot,
       knn.looCV_mod.ROC.plot,
       knn.repeatedCV.ROC.plot,
       knn.repeatedCV_mod.ROC.plot)
